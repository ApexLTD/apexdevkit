...
def test_should_create_from_date_time() -> None:
    ...
    date_time = DateTime.from_date_time("2024-05-29T21:27:05")
    assert date_time.timestamp_ms == 1717018025000
...
def test_should_create_from_date() -> None:
    ...
    date_time = DateTime.from_date("2024-05-29")
    assert date_time.timestamp_ms == 1716940800000
...
def test_should_create_date_time() -> None:
    ...
    assert date_time.as_date_time() == "2024-05-29T17:27:05"


def test_should_create_date() -> None:
    date_time = DateTime(1717003625000)

    assert date_time.as_date() == "2024-05-29"
